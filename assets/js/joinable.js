...
(function($, window)
{
	$.fn.preloadImages = function(callback){
	    ...
	    var $this = $(this),
	    	$images = $this.find('.preload-img > img, img.preload-img'),
	    	loaded = 0;
	    
	    // If no Images execute directly
	    if($images.length == 0)
	    	callback();
	...
	$.fn.preloadAllImages = function(callback){
 ...
 var SidebarMenuEffects = (function() {
	...
	function init() {
		...
		var container = document.getElementById( 'container' ),
			buttons = Array.prototype.slice.call( document.querySelectorAll( '#open-sidebar-menu > button' ) ),
		...
		buttons.forEach( function( el, i ) {
			...
			setTimeout(function()
			{
				if(jQuery(container).hasClass('auto-open'))
					jQuery(el).trigger(eventtype);
			}, 10);
					
			//jQuery(el).trigger(eventtype);//TMP
		} );
